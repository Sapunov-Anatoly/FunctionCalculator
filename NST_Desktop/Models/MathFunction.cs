...
{
    /// <summary> Класс, представляющий модель для функций. </summary>
    public class MathFunction
    {
        ...
        /// <summary> Список коэффициентов C. </summary>
        public List<int> CoefficientsC { get; }

        /// <summary> Задает функцию из пяти аргументов. </summary>
        public Func<double, double, double, double, double, double> Function { get; }

        /// <summary> Задает функцию из пяти аргументов, принимая только X и Y при вызове </summary>
